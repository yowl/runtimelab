...
{
    public class LLVMVTableSlotNode : ObjectNode, ISymbolDefinitionNode
    {
        private readonly MethodDesc _targetMethod;

        public LLVMVTableSlotNode(MethodDesc targetMethod)
        {
        ...
        {
            return comparer.Compare(_targetMethod, ((LLVMVTableSlotNode)other)._targetMethod);
        }
    }
}
