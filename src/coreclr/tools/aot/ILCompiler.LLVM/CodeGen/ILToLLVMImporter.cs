...
namespace Internal.IL
{
    ...
    partial class ILImporter
    {
        ...
        private void ImportCpOpj(int token)
        {
            ...
            PointerType pointerType = type.MakePointerType();
            LLVMTypeRef llvmPointerType = GetLLVMTypeForTypeDesc(pointerType);

            CastingStore(dest.ValueAsType(llvmPointerType, _builder), src, pointerType, true);
        }
