...
inline
BOOL
DataBlob::PeekU1(__sal_out BYTE *pnValue) const
{
...
inline
BOOL
DataBlob::PeekU2(__sal_out UINT16 *pnValue) const
{
...
inline
BOOL
DataBlob::PeekU4(__sal_out UINT32 *pnValue) const
{
...
inline
BOOL
DataBlob::PeekU8(__sal_out UINT64 *pnValue) const
{
...
inline
BOOL
DataBlob::GetU1(__sal_out BYTE *pnValue)
{
    if (m_cbSize < sizeof(BYTE))
    {
        return FALSE;
...
inline
BOOL
DataBlob::GetU2(__sal_out UINT16 *pnValue)
{
    if (m_cbSize < sizeof(UINT16))
    {
        return FALSE;
...
inline
BOOL
DataBlob::GetU4(__sal_out UINT32 *pnValue)
{
    if (m_cbSize < sizeof(UINT32))
    {
        return FALSE;
...
inline
BOOL
DataBlob::GetU8(__sal_out UINT64 *pnValue)
{
    if (m_cbSize < sizeof(UINT64))
    {
        return FALSE;
...
inline
BOOL
DataBlob::GetCompressedU(__sal_out UINT32 *pnValue)
{
...
inline
BOOL
DataBlob::StoreData(__sal_in const DataBlob *pSource)
{
