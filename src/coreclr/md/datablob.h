...
public:
    ...
    // data).
    __checkReturn __success(return) inline BOOL PeekU1(__sal_out BYTE   *pnValue) const;
    __checkReturn __success(return) inline BOOL PeekU2(__sal_out UINT16 *pnValue) const;
    __checkReturn __success(return) inline BOOL PeekU4(__sal_out UINT32 *pnValue) const;
    __checkReturn __success(return) inline BOOL PeekU8(__sal_out UINT64 *pnValue) const;
    ...
    __checkReturn __success(return) inline BOOL GetU1(__sal_out BYTE   *pnValue);
    __checkReturn __success(return) inline BOOL GetU2(__sal_out UINT16 *pnValue);
    __checkReturn __success(return) inline BOOL GetU4(__sal_out UINT32 *pnValue);
    __checkReturn __success(return) inline BOOL GetU8(__sal_out UINT64 *pnValue);
    ...
    inline BOOL PeekCompressedU(
        __sal_out UINT32 *pnValue,
        __sal_out UINT32 *pcbCompressedValueSize);
    ...
    __checkReturn
    __success(return)
    inline BOOL GetCompressedU(__sal_out UINT32 *pnValue);
    // Reads compressed integer (1, 2 or 4 bytes of format code:CompressedInteger#Format - returns the size
...
public:
    ...
    __checkReturn
    __success(return)
    inline BOOL StoreData(__sal_in const DataBlob *pSource);
