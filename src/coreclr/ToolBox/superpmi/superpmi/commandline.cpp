                               ...
                               LightWeightMap<DWORD, DWORD>** pForceJitOptions)
{
    ...
    DWORD keyIndex =
        (DWORD)targetjitOptions->AddBuffer((unsigned char*)key, sizeof(WCHAR) * ((unsigned int)PAL_wcslen(key) + 1));
    DWORD valueIndex =
        (DWORD)targetjitOptions->AddBuffer((unsigned char*)value, sizeof(WCHAR) * ((unsigned int)PAL_wcslen(value) + 1));
